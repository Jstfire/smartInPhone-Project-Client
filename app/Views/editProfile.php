...
<head>
    ...
    <title>Edit Profile - SmartInPhone</title>
        ...
        <div class="d-flex justify-content-center h-50" >
            <div class="user_card">
                ...
                <div class="d-flex justify-content-center form_container">
                    <form style="width: 320px" action="<?php echo base_url(); ?>/register/updateUser" method="post" enctype="multipart/form-data">
                        <div class="input-group mb-2">
                            <input name="avatar" type="file" value="<?php echo $_SESSION['avatar'];?>" class="form-control input_user" id="imgInp"/>
                        </div>
                        <div class="input-group mb-2">
                            <div class="input-group-append"> <span class="input-group-text"><i class="fa-solid fa-user-plus"></i></span> </div>
                            <input type="text" name="username" placeholder="Username" value="<?php echo $_SESSION['username'];?>" class="form-control input_user" disabled>
                        </div>
                        <div class="input-group mb-2">
                            <div class="input-group-append"> <span class="input-group-text"><i class="fas fa-user"></i></span> </div>
                            <input type="email" name="email" placeholder="Email" value="<?php echo $_SESSION['email'];?>" class="form-control input_user" disabled>
                        </div>
                        <div class="input-group mb-2">
                            <div class="input-group-append"> <span class="input-group-text"><i class="fa-solid fa-file-signature"></i></span> </div>
                            <input type="text" name="name" placeholder="Nama Lengkap" value="<?php echo $_SESSION['name'];?>" class="form-control input_user" required>
                        </div>
                        <div class="input-group mb-2">
                        ...
                        <div class="d-flex justify-content-center mt-2 login_container">
                            <button type="submit" onclick="on_submit()" class="btn login_btn">Change</button>
                        </div>
                    </form>
                </div>
            </div>
