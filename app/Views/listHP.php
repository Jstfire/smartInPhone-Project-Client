...
?>
        <title>List Handphone - SmartInPhone</title>
...
?>
    ...
    <div class="w-50 m-auto mt-1">
        <h1>List Handphone</h1><hr>
    </div>
    <div class="input-group flex-nowrap m-2">
        <span class="input-group-text" id="addon-wrapping">By Name</span>
        <input type="text" class="form-control" placeholder="Finding phone by name..." aria-label="Phone Name" aria-describedby="addon-wrapping" onkeyup="showHintName(this.value)">
    </div>
    ...
    <script src="<?php echo base_url();?>/assets/utils/suggestion.js"></script>
